...
Window::Window(const Props &props, EventBus &eventBus) : m_EventBus(eventBus) {
    Init(props);
}
...
void Window::PollEvents() {
    ...
    while (SDL_PollEvent(&event)) {
        ...
        case SDL_EVENT_MOUSE_MOTION: {
            MouseMoveEvent mouseMoveEvent{static_cast<double>(event.motion.x),
        ...
        case SDL_EVENT_MOUSE_WHEEL: {
            ...
            MouseScrollEvent scrollEvent{static_cast<double>(event.wheel.x),
