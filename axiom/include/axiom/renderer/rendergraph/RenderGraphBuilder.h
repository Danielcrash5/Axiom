...
public:
    ...
    // Transiente Resource: der Graph erzeugt/verwaltet die GPU-Textur selbst.
    [[nodiscard]] ResourceHandle createTexture(const TextureResourceDesc& desc);
    ...
    [[nodiscard]] ResourceHandle importTexture(rhi::TextureHandle externalHandle,
