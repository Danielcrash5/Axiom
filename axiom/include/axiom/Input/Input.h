...
namespace axiom {
    ...
    public:
        ...
        static float GetJoystickAxis(JoystickAxis axis, int id = 0, float deadzone = 0.1f);
        ...
        static bool IsJoystickHatJustPressed(JoystickHat mask, int hat = 0, int id = 0);
        static bool IsJoystickHatReleased(JoystickHat mask, int hat = 0, int id = 0);

        static bool RumbleJoystick(uint16_t lowFrequency, uint16_t highFrequency, uint32_t durationMs, int id = 0);
        static bool RumbleJoystickTriggers(uint16_t leftTrigger, uint16_t rightTrigger, uint32_t durationMs, int id = 0);
        static bool SetJoystickLED(uint8_t red, uint8_t green, uint8_t blue, int id = 0);
        ...
        static float GetCustomDeviceAxis(int axis, int id = 0, float deadzone = 0.0f);
        ...
        static bool IsCustomDeviceHatPressed(JoystickHat mask, int hat = 0, int id = 0);
        static bool IsCustomDeviceHatJustPressed(JoystickHat mask, int hat = 0, int id = 0);
        static bool IsCustomDeviceHatReleased(JoystickHat mask, int hat = 0, int id = 0);
    ...
    private:
        ...
        static std::array<std::array<bool, SDL_GAMEPAD_BUTTON_COUNT>, 4> s_CurrentGamepadButtons;
        static std::array<std::array<bool, SDL_GAMEPAD_BUTTON_COUNT>, 4> s_PreviousGamepadButtons;
