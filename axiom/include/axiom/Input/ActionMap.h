...
class ActionMap {
  public:
    ...
    void BindButton(const std::string &action, InputType type, int code,
                    int deviceId = 0);
    void BindHat(const std::string &action, InputType type, JoystickHat mask,
    ...
    void RebindButton(const std::string &action, size_t index, InputType type,
                      int code, int deviceId = 0);
